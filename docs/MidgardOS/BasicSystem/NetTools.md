...
License: GPL v2<br />
Version: 2.10<br />
URL: [https://sourceforge.net/projects/net-tools/files/net-tools-2.10.tar.xz/download](https://sourceforge.net/projects/net-tools/files/net-tools-2.10.tar.xz/download)<br />
...
```bash
install -m644 ../midgardos.github.io/docs/MidgardOS/src/net-tools/config.h config.h
```
