...
Version: 26.00<br />
URL: [https://www.7-zip.org/a/7z2600-src.tar.xz](https://www.7-zip.org/a/7z2600-src.tar.xz)<br />
...
```bash
mkdir -pv /sources/7z2600
cp -v 7z2600-src.tar.xz /sources/7z2600/
pushd /sources/7z2600
    tar xvf 7z2600-src.tar.xz
popd
```
...
```bash
pushd /sources/7z2600/CPP/7zip/Bundles/Alone2
    CC=gcc CXX=g++ make -j -f makefile.gcc
popd
```
...
```bash
pushd /sources/7z2600/CPP/7zip/Bundles/Alone2/_o
